...
class FlutterFlowAdRewarded extends StatefulWidget {
  const FlutterFlowAdRewarded({
    Key key,
    this.width,
    this.height,
  ...
  @override
  _FlutterFlowAdRewardedState createState() => _FlutterFlowAdRewardedState();
}

class _FlutterFlowAdRewardedState extends State<FlutterFlowAdRewarded> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.showsTestAd) {
      loadingText +=
          ...
          'height of the AdRewarded widget empty. AdRewarded will automatically'
